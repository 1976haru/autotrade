...
- [`docs/futures_broker_contract.md`](futures_broker_contract.md) — `FuturesBrokerAdapter` 공식 contract + `FuturesContractSpec` / `FuturesOrder` / 만기·롤오버 helper (#47).
- [`docs/futures_margin_risk.md`](futures_margin_risk.md) — `FuturesMarginRule` / `LeverageLimitRule` / `LiquidationRiskRule` 정책 + 임계 (#48).
- [`docs/futures_strategy_contract.md`](futures_strategy_contract.md) — `FuturesStrategyBase` + mock 전략 3종 (#49).
