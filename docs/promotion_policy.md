...
> **본 문서는 *주식* 승격 정책이다.** 선물은 별도 7단계 정책 — [`futures_promotion_policy.md`](futures_promotion_policy.md) (#76)를 따른다. 선물 AI 자동 실행은 본 프로젝트가 *영구* 허용하지 않는다 (단계 7 `FUTURES_AI_EXECUTION_BLOCKED`).
